...
In order to get the correct answer, one would have to know how closures work -- even though they might not know what the term "closure" is. This is a good example of testing someone through concept instead of terminology. And also, this question could be tagged for `Closures` since it's the knowledge unit.
